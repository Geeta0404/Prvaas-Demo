...
import {
  FaFacebookF, FaTwitter, FaYoutube, FaPhoneAlt, FaSearch, FaBars
} from 'react-icons/fa';
...
const Header = () => {
  ...
  return (
    <>
      {/* Top Contact Bar */}
      <div className="w-100 py-3 border-bottom" style={{ position: 'absolute', top: 0, left: 0, zIndex: 1000, backgroundColor: 'transparent' }}>
        <Container className="d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center gap-2 text-white">
            ...
            <div className="small">
              <div className="fw-bold">For Further Inquires :</div>
              <div>+01 (977) 2599 12</div>
            </div>
          </div>

          <div className="d-flex align-items-center gap-3">
            <Navbar.Brand href="/Prvaas">
      ...
      {/* Main Navbar */}
      <Navbar expand="lg" variant="dark" className="w-100 py-5" style={{ position: 'absolute', top: '60px', left: 0, zIndex: 1000, backgroundColor: 'transparent' }}>
        <Container className="d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center gap-3">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mx-auto gap-4">
              ...
              {!username ? (
                <Nav.Link as={NavLink} to="/login" className="text-uppercase fw-bold text-white">
                  Login
                </Nav.Link>
              ) : (
                <>
          ...
          <div className="d-flex align-items-center gap-3">
            <Button variant="primary" className="rounded-pill px-4 fw-bold">Book Now</Button>
